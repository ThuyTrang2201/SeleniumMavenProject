...
public class LoginTest_CodeStar extends CommonBase {
    ...
    public void loginSuccessfully()
    {
        ...
        WebElement Quanlynguoidung = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='Quản lý người dùng']")));
    ...
    public void LoginfailedWrongEmail()
    {
        ...
        handleInsecurePopup();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement errorMessage= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[normalize-space()='Email hoặc mật khẩu không đúng']")));
    ...
    @Test
     public void Logout() {
        ...
        WebElement Quanlynguoidung = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='Quản lý người dùng']")));
        assertTrue(Quanlynguoidung.isDisplayed());
        WebElement adminDropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("dropdownMenuLink")));
        adminDropdown.click();
        WebElement logoutButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//button[text()='Đăng xuất'])[1]")));
        logoutButton.click();
        WebElement sumitButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//button[text()='Đăng xuất'])[2]")));
        sumitButton.click();
